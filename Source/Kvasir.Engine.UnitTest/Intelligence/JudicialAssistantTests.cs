// --------------------------------------------------------------------------------------------------------------------
// <copyright file="JudicialAssistantTests.cs" company="nGratis">
...
public class JudicialAssistantTests
{
    public class FindCreaturesMethod
    {
            ...
            FindingCreaturesTheory theory)
        {
            ...
            var judicialAssistant = new JudicialAssistant(mockExecutionManager.Object);

            // Act.

            var creatures = judicialAssistant
